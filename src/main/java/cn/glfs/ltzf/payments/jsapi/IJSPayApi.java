package cn.glfs.ltzf.payments.jsapi;


import cn.glfs.ltzf.payments.jsapi.model.GetRefundOrderResponse;
import cn.glfs.ltzf.payments.jsapi.model.PrepayResponse;
import cn.glfs.ltzf.payments.jsapi.model.QueryOrderByOutTradeNoResponse;
import cn.glfs.ltzf.payments.jsapi.model.RefundOrderResponse;
...
public interface IJSPayApi {
     ...
     */
    @FormUrlEncoded
    @POST("api/wxpay/jsapi_convenient")
